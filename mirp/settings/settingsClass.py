...
from typing import Union, List, Tuple, Any, Optional, Iterable
...
class SettingsClass:
    ...
    def __init__(
            ...
            roi_interpolate_settings: Optional[RoiInterpolationSettingsClass] = None,
        ...
        if roi_interpolate_settings is None:
            roi_interpolate_settings = RoiInterpolationSettingsClass(**kwargs)
