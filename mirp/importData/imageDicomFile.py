...
class MaskDicomFile(MaskFile):
    def __init__(
        ...
        # These are set using the 'complete' method.
        self.reference_frame_of_reference_uid = None
        self.reference_sop_instance_uid = None
    ...
    def complete(self):
        ...
        # Set SOP instance UID.
        self.reference_sop_instance_uid = ... # get_pydicom_meta_tag(dcm_seq=dcm, tag=(0x0008, 0x0018), tag_type="str")

        # Set Frame of Reference UID (if any)
        self.reference_frame_of_reference_uid = ... # get_pydicom_meta_tag(dcm_seq=dcm, tag=(0x0020, 0x0052),
                                                                       #tag_type="str")
